            ...
            <div class="row">
              <div class="col">
                ...
                <input
                  ...
                  value="2021-07-12"
                  data-val="true"
                  data-val-required="The date cover ends field is required."
                />
              </div>
            </div>
            ...
            <div class="row mt-3">
              <div class="col">
                ...
                <input
                  ...
                  value=""
                  data-val="true"
                  data-val-required="The provider company name field is required."
                />
              </div>
            </div>
          </div>
